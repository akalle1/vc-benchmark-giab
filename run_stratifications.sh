...
for STRAT in acmg84_difficult acmg84_lowmap_segdup acmg84_easy; do
    ...
    OUT_PREFIX="results/benchmark/deepvariant_hifi_HG002_30x_${STRAT}"

    echo "Running hap.py: deepvariant_hifi vs ${STRAT} at $(date)"
    ...
    echo "Finished: deepvariant_hifi vs ${STRAT} at $(date)"
